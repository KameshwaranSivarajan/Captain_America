...
Here is the link to your knowledge base [https://iframe-test.document360.net](https://iframe-test.document360.net){target="_blank"}. 

The knowledge base then got two important factors. A professional-looking **Customize site - Home** and [the docs](https://iframe-test.document360.net/docs) (the knowledge base content).
